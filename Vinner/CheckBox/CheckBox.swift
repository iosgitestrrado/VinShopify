...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var uncheckedBorderColor: UIColor = #colorLiteral(red: 0.3764705882, green: 0.2235294118, blue: 0.07450980392, alpha: 1)
    
    @IBInspectable
    var checkedBorderColor: UIColor = #colorLiteral(red: 0.3764705882, green: 0.2235294118, blue: 0.07450980392, alpha: 1)
    
    @IBInspectable
    var checkmarkColor: UIColor = #colorLiteral(red: 0.3764705882, green: 0.2235294118, blue: 0.07450980392, alpha: 1)
    
    var checkboxBackgroundColor: UIColor! = .clear
    ...
    open override func draw(_ rect: CGRect) {
        ...
        context.setStrokeColor(self.isChecked ? checkedBorderColor.cgColor : checkedBorderColor.cgColor)
