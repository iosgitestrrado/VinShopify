...
extension UIViewController {
    ...
    func showToast(message : String) {
        ...
        UIView.animate(withDuration: 12.0, delay: 0.2, options: .curveEaseOut, animations: {
    ...
    */
    ...
    func addCustControls() {
        ...
        if (UserDefaults.standard.value(forKey: "notify_count") as! String == "0")
        {
            ...
            btnNotify.setImage(imageNotify, for: .normal)
            btnNotify.addTarget(self, action: #selector (loadNotification), for: .touchUpInside)
                    btnNotify.setTitle("", for: .normal);
                    btnNotify.sizeToFit()
                    let barButtonNotify = UIBarButtonItem(customView: btnNotify)
        ...
        else
        {
            ...
            badgeCount.text = (UserDefaults.standard.value(forKey: "notify_count") as! String)
            ...
            btnNotify.setImage(imageNotify, for: .normal)
            btnNotify.addTarget(self, action: #selector (loadNotification), for: .touchUpInside)
            btnNotify.addSubview(badgeCount)
    ...
    func addBackButton1(title:String)
    {
        let btnLeftMenu: UIButton = UIButton()
        let image = UIImage(named: "CustomBack");
        btnLeftMenu.setImage(image, for: .normal)
        btnLeftMenu.setTitle(title, for: .normal);
        btnLeftMenu.sizeToFit()
        btnLeftMenu.addTarget(self, action: #selector (backButtonClick1(sender:)), for: .touchUpInside)
        let barButton = UIBarButtonItem(customView: btnLeftMenu)
        self.navigationItem.leftBarButtonItem = barButton
    ...
    @objc func backButtonClick1(sender : UIButton) {
